...
import com.example.udacitycode.R
import com.example.udacitycode.databinding.FragmentGameWonBinding
...
class GameWonFragment : Fragment() {
    ...
    private fun getShareIntent(): Intent? {
        val args = GameWonFragmentArgs.fromBundle(requireArguments())
        return ShareCompat.IntentBuilder.from(context as Activity).setType("text/plain").setText(R.string.share_success_text.toString()+", "+ args.numCorrect+" ,"+ args.numQuestions).intent
    }
}
